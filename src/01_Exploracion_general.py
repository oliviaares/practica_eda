...
import os
print(os.getcwd())  # Verifica el directorio actual
...
# Distribución de ORGANIZATION_TYPE
...
# Porcentaje de incumplimiento: Tipos de organización como “Transport Type 3” y algunas industrias específicas presentan mayores tasas de incumplimiento.
# 
...
# Porcentaje de incumplimiento: Los clientes solteros y en matrimonios civiles muestran mayores tasas de incumplimiento en comparación con los casados.
# 
...
# Porcentaje de incumplimiento: Los clientes desempleados y en baja por maternidad tienen las mayores tasas de incumplimiento.
# 
...
# Porcentaje de incumplimiento: Las ocupaciones de baja cualificación, como “Low-skill laborers”, tienen las mayores tasas de incumplimiento.
# 
...
# Porcentaje de incumplimiento: Los niveles educativos más bajos, como educación secundaria incompleta, presentan las mayores tasas de incumplimiento.
# 
...
# Porcentaje de incumplimiento: Las personas que viven en apartamentos alquilados presentan las mayores tasas de incumplimiento.
# Importancia: El tipo de vivienda puede ser un reflejo de la estabilidad financiera de los clientes y de su capacidad para asumir compromisos financieros a largo plazo.
# 
# ---
# 
...
# Porcentaje de incumplimiento: Los hombres tienen una mayor tasa de incumplimiento en los préstamos comparado con las mujeres.
# Importancia: Esta variable es relevante porque puede revelar diferencias significativas en el comportamiento crediticio entre géneros, lo cual puede influir en los resultados del modelo predictivo y las estrategias de mitigación de riesgos.
# 
# ---
# 

# #### **¿Por qué elegimos estas variables?**
# Relación directa con el incumplimiento: Cada variable seleccionada tiene un impacto potencial en la capacidad del cliente para cumplir con los pagos del préstamo.
# Segmentación efectiva: Los gráficos permiten identificar grupos específicos con mayor riesgo de incumplimiento.
# 
# Relevancia sociodemográfica y económica: Factores como género, ocupación, nivel educativo y tipo de vivienda son determinantes clave en el análisis de crédito.
# 
# Optimización del modelo predictivo: Incluir estas variables en el análisis ayuda a construir un modelo más robusto que puede predecir mejor el comportamiento de los clientes.
# 
# ---
