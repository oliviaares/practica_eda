...
print(data_transformed.head(10))
...
# 
# **Gráfico de YEARS_BEGINEXPLUATATION_AVG:**
...
# 
# **Gráfico de EMERGENCYSTATE_MODE:**
...
# Aquí usamos la mediana como ejemplo de imputación.
for col in pd_missing_continuous[pd_missing_continuous['nulos'] > 0].index:
    data_train[col] = data_train[col].fillna(data_train[col].median())

print("\nValores nulos después de imputación:")
print(data_train[list_var_continuous].isnull().sum())
...
confusion_matrix = pd.crosstab(data_train["NAME_CONTRACT_TYPE"], data_train["CODE_GENDER"])
...
# 
# **3. Correlaciones negativas notables**
...
# 
# **4. Áreas de interés para modelado**
